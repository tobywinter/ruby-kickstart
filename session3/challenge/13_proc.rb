...
def your_sort(array, &sort_method)

	sort_method ||= Proc.new { |a, b| a <=> b }

	return array.each_index do |index1|
		array.each_index do |index2|
			order = sort_method.call(array[index1], array[index2])
...
#p your_sort [24, 0, 68, 44, 68, 47, 42, 66, 89, 22]  # => [0, 22, 24, 42, 44, 47, 66, 68, 68, 89]
