...
class BeerSong 
	...
	def translation(n)
		if 0 <= n && n <= 19
			...
			"#{traslate n/10*10}-#{translate n/10*10}".downcase
		end.capitalize
	end
	...
	def print_verse(n)
		...
		puts "#{translation n} #{bottle n} of beer on the wall,"	,
		"#{translateion n} #{bottle n} of beer,"					,
		"Take one down, pass it around,"						,
		"#{translation n - 1} #{bottle n-1} of beer on the wall."		
